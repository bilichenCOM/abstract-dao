...
public class StringUserModel {
	...
	public StringUserModel(String name, String surname, String language, String country) {
		this.name = name;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		StringUserModel other = (StringUserModel) obj;
		if (country == null) {
	...
	public String toString() {
		return "StringUserModel [name=" + name + ", surname=" + surname + ", language=" + language + ", country="
				+ country + "]";
	}
}